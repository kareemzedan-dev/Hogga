...
class RegisterDetailsScreen extends StatefulWidget {
  ...
  const RegisterDetailsScreen({super.key, required this.phone, required this.password});
        ...
        child: Column(
          ...
          children: [
            ...
            AuthTextField(
              ...
              prefixIcon: Icon(Icons.email_outlined, color: context.colors.primary, size: 20),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _agreeToTerms ? context.colors.primary : Colors.transparent,
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(
                        color: _agreeToTerms ? context.colors.primary : context.textSecondary.withValues(alpha: 0.5),
                      ),
                    ),
                    child: _agreeToTerms
            ...
            const SizedBox(height: 20),
             Center(
              child: TextButton(
                onPressed: () => Navigator.pushNamed(context, AppRoutes.lawyerOnboarding),
                child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
  ...
  Widget _buildSelectableCard({
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: 16),
        decoration: BoxDecoration(
          color: isSelected ? context.colors.primary.withValues(alpha: 0.2) : context.colors.surface,
