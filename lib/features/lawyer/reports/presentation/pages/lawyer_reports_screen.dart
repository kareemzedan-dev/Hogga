...
class _LawyerReportsScreenState extends State<LawyerReportsScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          sl<LawyerReportsCubit>()..fetchReports(period: _selectedPeriodKey),
      child: Scaffold(
        backgroundColor: context.pageBg,
        appBar: MainAppbar(title: AppStrings.performanceReports.tr(context)),
            ...
            child: ChoiceChip(
              ...
              onSelected: (v) {
                if (v) {
                  ...
                  context.read<LawyerReportsCubit>().fetchReports(
                    period: entry.key,
                  );
                }
              },
