...
class CasesRemoteDataSourceImpl implements CasesRemoteDataSource {
  ...
  Future<List<LawyerCaseModel>> getCases({String? type}) async {
    ...
    return (response.data['data'] as List).map((e) {
      ...
      return LawyerCaseModel.fromJson(json);
    }).toList();
  }
  ...
  Future<LawyerCaseDetailsModel> getCaseDetails(int caseId) async {
    ...
    final Map<String, dynamic> json = Map<String, dynamic>.from(response.data['data']);



    return LawyerCaseDetailsModel.fromJson(json);
  }
