...
abstract class BainahRepository {
...
class BainahRepositoryImpl implements BainahRepository {
  final BainahRemoteDataSource remoteDataSource;

  BainahRepositoryImpl({required this.remoteDataSource});
