...
abstract class BainahRemoteDataSource {
...
class BainahRemoteDataSourceImpl implements BainahRemoteDataSource {
  final ApiClient apiClient;

  BainahRemoteDataSourceImpl({required this.apiClient});
